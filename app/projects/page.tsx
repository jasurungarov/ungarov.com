  ...
  return (
    <div className="p-6 rounded-2xl">
      ...
      <div className="flex justify-center mb-8 ml-3 mr-3">
        <div className="flex bg-card rounded-full p-1.5 shadow-[0_0_10px_rgba(0,0,0)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredProjects.map((project) => (
          <div key={project.id} className="group bg-card rounded-xl overflow-hidden transform hover:scale-105
            transition-all duration-300 shadow-[0_0_10px_rgba(0,0,0)]">
            <div className="relative h-48 overflow-hidden">
              {isLoading && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-card/40 z-10 backdrop-blur-sm">
            ...
            <div className="p-5">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.technologies.map((tech) => (
                  <span key={tech} className="bg-primary px-2 py-1 rounded text-xs shadow-[0_0_2px_rgba(0,0,0)]">
                    {tech}
                  </span>
                ))}
              </div>
